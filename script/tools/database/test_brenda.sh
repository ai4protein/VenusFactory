...
# Run from project root: bash script/tools/database/test_brenda.sh
...
python src/tools/database/brenda/brenda_operations.py --test 2>&1 | tee "$OUT_DIR/test_brenda_operations.log"
