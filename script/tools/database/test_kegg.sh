...
# Academic use only. Run from project root: ./script/tools/database/test_kegg.sh
...
python src/tools/database/kegg/kegg_operations.py --test 2>&1 | tee "${OUT_DIR}/test_kegg_operations.log"
