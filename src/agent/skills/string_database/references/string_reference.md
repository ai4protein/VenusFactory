...
|---------------|-----------------|--------|
| get_string_ids | `string_map_ids` | `string_map_ids.py` |
| network (TSV) | `string_network` | `string_network.py` |
| image/network | `string_network_image` | `string_network_image.py` |
| interaction_partners | `string_interaction_partners` | `string_interaction_partners.py` |
| enrichment | `string_enrichment` | `string_enrichment.py` |
| ppi_enrichment | `string_ppi_enrichment` | `string_ppi_enrichment.py` |
