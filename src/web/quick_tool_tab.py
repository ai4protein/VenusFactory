...
def create_quick_tool_tab(constant: Dict[str, Any]) -> Dict[str, Any]:
    """Use Column instead of Blocks - nested Blocks causes Component ID 559 not found in Gradio 6."""
    ...
    with gr.Column():
            ...
            with gr.Tab("Directed Evolution"):
                with gr.Row(equal_height=False):
                    with gr.Column(scale=2):
                        ...
                        with gr.Column(visible=False) as easy_zshot_sequence_section:
            ...
            with gr.Tab("Protein Function Prediction"):
                with gr.Row(equal_height=False):
                    with gr.Column(scale=2):
                        ...
                        with gr.Column(visible=False) as base_function_sequence_section:
                            gr.Markdown("## Sequence")
                    ...
                    with gr.Column(scale=3):
                        ...
                        easy_func_result_state = gr.State()
            ...
            with gr.Tab("Functional Residue "):
                with gr.Row(equal_height=False):
                    with gr.Column(scale=2):
                        ...
                        with gr.Column(visible=False) as base_residue_function_sequence_section:
                            gr.Markdown("## Sequence")
                    ...
                    with gr.Column(scale=3):
                        ...
                        base_residue_function_result_state = gr.State()

            with gr.Tab("Physicochemical Property"):
                with gr.Row(equal_height=False):
                    with gr.Column(scale=2):
                        ...
                        with gr.Column(visible=False) as protein_properties_sequence_section:
                            gr.Markdown("## Sequence")
        ...
        easy_zshot_file_upload.upload(
            ...
            outputs=[easy_zshot_protein_display, easy_zshot_sequence_selector, easy_zshot_sequence_state, easy_zshot_selected_sequence_state, easy_zshot_original_file_path_state, easy_zshot_current_file_state, easy_zshot_sequence_section]
        )
        ...
        easy_zshot_paste_clear_btn.click(
            ...
            outputs=[easy_zshot_paste_content_input, easy_zshot_protein_display, easy_zshot_sequence_selector, easy_zshot_sequence_state, easy_zshot_selected_sequence_state, easy_zshot_original_file_path_state, easy_zshot_sequence_section]
        )
        easy_zshot_paste_content_btn.click(
            fn=lambda c: wrap_paste_show_section(parse_fasta_paste_content(c)),
            inputs=easy_zshot_paste_content_input,
            outputs=[easy_zshot_protein_display, easy_zshot_sequence_selector, easy_zshot_sequence_state, easy_zshot_selected_sequence_state, easy_zshot_original_file_path_state, easy_zshot_original_paste_content_state, easy_zshot_sequence_section]
        )
        ...
        easy_zshot_predict_btn.click(
            ...
            inputs=[zero_shot_function_dd, easy_zshot_file_upload, enable_ai_zshot, llm_dd_zshot, api_key_in_zshot, zero_shot_model_dd],
        ...
        base_function_fasta_upload.upload(
            ...
            outputs=[base_function_protein_display, base_function_selector, base_function_sequence_state, base_function_selected_sequence_state, base_function_original_file_path_state, base_function_current_file_state, base_function_sequence_section]
        )
        ...
        base_func_paste_clear_btn.click(
            fn=lambda: wrap_clear_hide_section(clear_paste_content_fasta()),
            outputs=[base_func_paste_content_input, base_function_protein_display, base_function_selector, base_function_sequence_state, base_function_selected_sequence_state, base_function_original_file_path_state, base_function_sequence_section]
        )

        base_func_paste_content_btn.click(
            fn=lambda c: wrap_paste_show_section(parse_fasta_paste_content(c)),
            inputs=base_func_paste_content_input,
            outputs=[base_function_protein_display, base_function_selector, base_function_sequence_state, base_function_selected_sequence_state, base_function_original_file_path_state, base_function_original_paste_content_state, base_function_sequence_section]
        )
        ...
        easy_func_predict_btn.click(
            ...
            inputs=[easy_func_task_dd, base_function_fasta_upload, enable_ai_func, llm_dd_func, api_key_in_func],
            outputs=[function_status_textbox, function_results_df, function_download_btn, function_ai_expert_html, easy_func_result_state], 
            show_progress=True
        )
        ...
        base_residue_function_fasta_upload.upload(
            ...
            outputs=[base_residue_function_protein_display, base_residue_function_selector, base_residue_function_sequence_state, base_residue_function_selected_sequence_state, base_residue_function_original_file_path_state, base_residue_function_current_file_state, base_residue_function_sequence_section]
        )
        ...
        base_residue_function_paste_clear_btn.click(
            fn=lambda: wrap_clear_hide_section(clear_paste_content_fasta()),
            outputs=[base_residue_function_paste_content_input, base_residue_function_protein_display, base_residue_function_selector, base_residue_function_sequence_state, base_residue_function_selected_sequence_state, base_residue_function_original_file_path_state, base_residue_function_sequence_section]
        )
        base_residue_function_paste_content_btn.click(
            fn=lambda c: wrap_paste_show_section(parse_fasta_paste_content(c)),
            inputs=base_residue_function_paste_content_input,
            outputs=[base_residue_function_protein_display, base_residue_function_selector, base_residue_function_sequence_state, base_residue_function_selected_sequence_state, base_residue_function_original_file_path_state, base_residue_function_original_paste_content_state, base_residue_function_sequence_section]
        )
        ...
        base_residue_function_predict_btn.click(
            ...
            inputs=[base_residue_function_task_dd, base_residue_function_fasta_upload, enable_ai_residue_function, llm_dd_residue_function, api_key_in_residue_function],
            outputs=[base_residue_function_status_textbox, base_residue_function_results_df, base_residue_function_plot_out, base_residue_function_download_btn, base_residue_function_ai_expert_html, base_residue_function_result_state],
            show_progress = True
        )
        ...
        protein_properties_file_upload.upload(
            ...
            outputs=[protein_properties_protein_display, protein_properties_sequence_selector, protein_properties_sequence_state, protein_properties_selected_sequence_state, protein_properties_original_file_path_state, protein_properties_current_file_state, protein_properties_sequence_section]
        )
        ...
        protein_properties_paste_clear_btn.click(
            fn=lambda: wrap_clear_hide_section(clear_paste_content_fasta()),
            outputs=[protein_properties_paste_content_input, protein_properties_protein_display, protein_properties_sequence_selector, protein_properties_sequence_state, protein_properties_selected_sequence_state, protein_properties_original_file_path_state, protein_properties_sequence_section]
        )
        protein_properties_paste_content_btn.click(
            fn=lambda c: wrap_paste_show_section(parse_fasta_paste_content(c)),
            inputs=protein_properties_paste_content_input,
            outputs=[protein_properties_protein_display, protein_properties_sequence_selector, protein_properties_sequence_state, protein_properties_selected_sequence_state, protein_properties_original_file_path_state, protein_properties_original_paste_content_state, protein_properties_sequence_section]
        )
        ...
        protein_properties_predict_btn.click(
            ...
            outputs=[protein_properties_status_box, protein_properties_result_out, protein_properties_download_btn, protein_properties_path_state, protein_properties_full_data_state],
            show_progress=True
        )
