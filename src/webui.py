...
def create_ui():
    ...
    # Combine all CSS and add Google Analytics
    css_links = f"""
    <!-- Google Analytics -->
    <script async src="https://www.googletagmanager.com/gtag/js?id=G-NKK4BBTN8W"></script>
    <script>
      window.dataLayer = window.dataLayer || [];
      function gtag(){{dataLayer.push(arguments);}}
      gtag('js', new Date());
      gtag('config', 'G-NKK4BBTN8W');
      
      // Track page load
      window.addEventListener('load', function() {{
        gtag('event', 'page_view', {{
          'page_title': 'VenusFactory - AI Protein Engineering Platform',
    ...
    with gr.Blocks(css=css_links) as demo:
        ...
        <div class="header-container" style="display: flex; align-items: center; justify-content: space-between; margin-bottom: 20px;">
            ...
            <div style="display: flex; gap: 10px;">
                <a href="https://github.com/ai4protein/VenusFactory" target="_blank" class="github-button" style="text-decoration: none; display: flex; align-items: center; padding: 10px 15px; background: #f4f4f4; color: #333; border: 2px solid #e0e0e0; border-radius: 8px; font-weight: 600; transition: all 0.3s ease; box-shadow: 0 2px 8px rgba(0,0,0,0.1);" onclick="gtag('event', 'click', {{'event_category': 'External Link', 'event_label': 'GitHub'}});">
                ...
                <a href="https://huggingface.co/AI4Protein" target="_blank" class="huggingface-button" style="text-decoration: none; display: flex; align-items: center; padding: 10px 15px; background: #f4f4f4; color: #333; border: 2px solid #e0e0e0; border-radius: 8px; font-weight: 600; transition: all 0.3s ease; box-shadow: 0 2px 8px rgba(0,0,0,0.1);" onclick="gtag('event', 'click', {{'event_category': 'External Link', 'event_label': 'Hugging Face'}});">
                    🤗
                    Hugging Face
                </a>
            </div>
