...
Configure matplotlib style preferences and generate custom .mplstyle files.
Creates a preview of the style; supports presets and interactive mode.

Skill (for Agent): src/agent/skills/matplotlib/
  - SKILL.md, references/styling_guide.md

Usage:
    python -m src.tools.visualize.matplotlib.style_configurator [--preset PRESET] [--output FILE] [--preview]
...
Presets: publication, presentation, web, dark, minimal
"""
import argparse
import os
...
# Predefined style presets (see SKILL references/styling_guide.md)
STYLE_PRESETS = {
    "publication": {
        "figure.figsize": (8, 6),
        "figure.dpi": 100,
