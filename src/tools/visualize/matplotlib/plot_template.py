...
Use this as a starting point for publication-quality visualizations.

Skill (for Agent): src/agent/skills/matplotlib/
  - SKILL.md, references/plot_types.md, references/styling_guide.md

Usage:
    python -m src.tools.visualize.matplotlib.plot_template [--plot-type TYPE] [--style STYLE] [--output FILE]

Plot types: line, scatter, bar, histogram, heatmap, contour, box, violin, 3d, all
"""
import argparse
...
def main():
    ...
    parser = argparse.ArgumentParser(
        description="Matplotlib plot template (see src/agent/skills/matplotlib/SKILL.md)",
...
Examples:
  ...
  python -m src.tools.visualize.matplotlib.plot_template --plot-type all --style seaborn-v0_8-whitegrid
    ...
    parser.add_argument(
        ...
        type=str,
        default="all",
        choices=["line", "scatter", "bar", "histogram", "heatmap", "contour", "box", "violin", "3d", "all"],
        help="Type of plot to create",
    )
    parser.add_argument("--style", type=str, default="default", help="Matplotlib style name (e.g. seaborn-v0_8-whitegrid)")
