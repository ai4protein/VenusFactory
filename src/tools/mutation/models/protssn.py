...
from src.tools.mutation.utils import safe_index, one_hot_res, log, dihedral, NormalizeProtein
from src.tools.mutation.models.egnn.network import EGNN
...
def protssn_score(pdb_file: str, mutants: List[str], 
                  ...
                  gnn_config_path: str = "src/tools/mutation/models/egnn/egnn.yaml",
    ...
    if gnn_config_path is None:
        gnn_config_path = "src/tools/mutation/models/egnn/egnn.yaml"
    # Load GNN config
    ...
    if use_ensemble:
        ...
        for k in [10, 20, 30]:
            norm_file = f'src/tools/mutation/models/egnn/norm/cath_k{k}_mean_attr.pt'
        ...
        norm_file = f'src/tools/mutation/models/egnn/norm/cath_k{c_alpha_max_neighbors}_mean_attr.pt'
