...
def _create_protssn_wrapper(args):
    ...
    from src.tools.mutation.models.protssn import ProtSSN, PLM_model, GNN_model
    from src.tools.mutation.utils import NormalizeProtein
    ...
    gnn_config_path = getattr(args, "gnn_config", None) or "src/tools/mutation/models/egnn/egnn.yaml"
