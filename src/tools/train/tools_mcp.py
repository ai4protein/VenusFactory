# training/tools_mcp: 配置生成、agent 生成代码执行、训练/预测执行逻辑（从根 tools_agent 迁入）
import json
import os
import re
import time
...
def generate_ai_training_config(analysis: dict, user_requirements: Optional[str] = None) -> dict:
    ...
    try:
        ...
        prompt = f"""You are VenusFactory, 蛋白质工程的AI助手 (AI assistant for protein engineering). You are an expert in protein machine learning. Generate optimal training configuration following these STRICT rules:
