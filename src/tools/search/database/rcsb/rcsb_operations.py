...
try:
    ...
    if _dir.name == "rcsb" and str(_dir.parents[4]) not in sys.path:
        sys.path.insert(0, str(_dir.parents[4]))
    from src.tools.search.database.rcsb.rcsb_metadata import query_rcsb_entry as _raw_query_entry
...
try:
    ...
    from src.tools.search.database.rcsb.rcsb_structure import query_rcsb_structure as _raw_query_structure
    from src.tools.search.database.rcsb.rcsb_structure import download_rcsb_structure as _raw_download_structure
